...
public class KafkaConfiguration {
    ...
    public ConcurrentMessageListenerContainer<String, String> replyContainer(ConcurrentKafkaListenerContainerFactory<String, String> factory) {
        ...
        ConcurrentMessageListenerContainer<String, String> repliesContainer = factory.createContainer(replyCheckOrderStatusCompletionOfTableTopic,
                                                                                                      replyCheckOrderStatusCompletionOfTablesTopic);
